...
const Index = () => {
  ...
  const stats = [
    { label: "Carbon Credits Generated", value: "152,400", suffix: "tons CO₂e" },
    { label: "Active Projects", value: "47", suffix: "restoration sites" },
    { label: "Trading Volume", value: "₹24.5M", suffix: "24h volume" },
    { label: "Community Partners", value: "128", suffix: "NGOs & Panchayats" }
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(${vayuHero})` }}
        >
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <div className="max-w-5xl mx-auto animate-fade-in">
            <div className="flex justify-center mb-6">
              <Badge className="mission-badge text-white px-6 py-2 text-sm font-medium">
                Smart India Hackathon 2024 • Problem Statement #25038
              </Badge>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              ...
              <Button 
                ...
                onClick={() => document.getElementById('carbon-map')?.scrollIntoView({ behavior: 'smooth' })}
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
              {stats.map((stat, index) => (
                <Card key={index} className="bg-card/50 backdrop-blur-sm border-border/20 hover:bg-card/70 transition-colors">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="bg-gradient-card border-border/20 shadow-card-vayu hover:shadow-glow transition-all duration-500 group animate-scale-in">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              {[
                "Transparent MRV system for blue carbon ecosystems",
                "Community empowerment through carbon credit generation", 
                "Real-time tracking of restoration progress",
                "Blockchain-verified environmental impact data",
                "Corporate ESG compliance and offset tracking"
              ].map((item, index) => (
